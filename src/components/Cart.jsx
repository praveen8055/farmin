...
// <button
//   onClick={() => {
//     navigate('/checkout', { state: { useExistingAddress: true } });
//   }}
//   className="flex-1 bg-black text-white py-2 rounded-lg hover:bg-gray-800"
// >
//   Use this address
...
// <button
//   onClick={() => {
//     navigate('/checkout', { state: { useExistingAddress: false } });
//   }}
...
//         {products.map((product) => (
//           cartItems[product.id] > 0 && (
//             <div key={product.id} className="flex items-center gap-6 border-b pb-6 group">
//               <img 
//                 src={product.image} 
//                 alt={product.name}
//                 className="w-32 h-32 object-contain rounded-lg bg-gray-50 p-4"
...
//             <div className="flex justify-between text-lg">
//               <span className="text-black">Subtotal</span>
//               <span className="font-medium text-black">{currency}{getTotalCartAmount()}</span>
//             </div>
//             <div className="flex justify-between text-lg">
//               <span className="text-black">Delivery</span>
//               <span className="font-medium text-black">
...
//             onClick={handleCheckout}
//             className="w-full bg-black text-white py-4 rounded-full 
//                      hover:bg-white  hover:bg-transparent border border-transparent hover:border-black hover:text-black transition-colors text-lg font-medium
